...
formRecargar.addEventListener("submit", function (event) {
	...
	if (name && name != "") {
		window.open(`https://wa.me/584120663036?text=¡Hola! Mi nombre es ${name.toUpperCase()}. Me interesa realizar una recarga *${operator.value}* por *${amount.value} Bs* al número *${serviceNumber.value}*`);
	} else if (name == "") {
